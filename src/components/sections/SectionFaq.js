  ...
  render() {
    return (
      <section
        ...
        className={'block faq-block bg-' + _.get(this.props, 'section.bg') + ' outer'}>
        <div className="inner-small">
          ...
          {_.get(this.props, 'section.faqitems') && (
            <dl className="faq-accordion">
              {_.map(_.get(this.props, 'section.faqitems'), (faqitem, faqitem_idx) => (
                <React.Fragment key={faqitem_idx}>
                  ...
                  <dd key={faqitem_idx} className="accordion-panel">
                    <div className="accordion-content">{markdownify(_.get(faqitem, 'answer'))}</div>
                  </dd>
                </React.Fragment>
              ))}
            </dl>
